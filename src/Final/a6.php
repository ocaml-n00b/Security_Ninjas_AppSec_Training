		...
		<!-- Nav -->
			...
			<div class="wrapper style2">
				<article id="work">
						...
						<h5>A6 : Sensitive Data Exposure</h5><br>
					...
					<FORM NAME="priceform">
						<br>
					<B><FONT SIZE="6" COLOR="">Calculate total price</FONT></B><P>

					<TABLE BORDER="1" WIDTH="35%" BGCOLOR="">
						<TR>
							<TD WIDTH="53%"><B>Package</B></TD>
							<TD WIDTH="16%"><B>Quantity</B></TD>
							<TD WIDTH="17%"><B>Years</B></TD>
							<TD WIDTH="14%"><B>$</B></TD>
						</TR>
						...
						<TR>
							...
							<TD><INPUT TYPE="TEXT" NAME="Cost1" SIZE="8" VALUE=0 ></TD>
						</TR>
						<TR>
